<template>
  <div>
    <t-divider>demo4：4列</t-divider>
    <t-form :data="formData" labelWidth="120px" @reset="onReset" @submit="onSubmit">
      <g-filter-wrapper :expand="expand">
        <t-form-item label="字段1" name="field1">
        ...
        <t-form-item label="字段5" name="field5">
          <t-input v-model="formData.field5"></t-input>
        </t-form-item>
        <t-form-item label="字段6" name="field6">
          <t-input v-model="formData.field6"></t-input>
        </t-form-item>
